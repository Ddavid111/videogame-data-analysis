\Chapter{Osztályozási feladatok megoldása}
...
Az első domain a videójátékok sikerességének becslésére fókuszál
...
\begin{figure}[H]
    ...
    \caption{Konfúziós mátrix a videójátékok sikerességének becslésére (logisztikus regresszió)}
...
hogy a modell mely bemeneti változókat tekinti meghatározónak a videójátékok
...
A második vizsgált osztályozási probléma a videójátékok multiplayer és
