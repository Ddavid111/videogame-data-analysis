...
A 2010 előtti időszakban a megjelenésszámok viszonylag alacsonyak voltak, és jellemzően a hagyományos kiadói modell dominált. Ebben az érában a belépési küszöb magasabb volt, az önálló fejlesztők és kisebb stúdiók megjelenése még korlátozott szerepet játszott a platform kínálatában.
...
A 2010 utáni időszakban a megjelenésszámok jelentős növekedése figyelhető meg, különösen 2014-et követően. A 2020 és 2024 közötti években a megjelenések száma stabilan 10–20 ezer közötti tartományban mozgott évente, ami jól tükrözi a digitális disztribúció térnyerését és a platform nyitottabbá válását a kisebb fejlesztők számára.
...
\subsubsection{Forrás szerinti bontás (A, B, C kategória)}
...
Az \textbf{A} forrás esetében jól látható, hogy a megjelenések száma
korlátozottabb, és elsősorban a korábbi évek játékait fedi le.
...
A \textbf{B} forrás növekedése jóval dinamikusabb.
A 2019 utáni időszakban különösen jelentős emelkedés figyelhető meg,
...
mivel az adathalmaz csak az év első hónapjait tartalmazza.

\subsubsection{Top 5 műfaj időbeli trendje}
...
\subparagraph{Pearson-korreláció}
...
\subparagraph{Spearman-korreláció}
...
\subsubsection{Éves növekedési faktor (logaritmikus skálán)}

Az alábbi ábra az egyes évek közötti növekedési faktort mutatja be,
...
\subsubsection{Év $\times$ nap hőtérkép}

Az alábbi hőtérkép az egyes évek és naptári napok mentén mutatja
...
\subsubsection{Év $\times$ (ISO hét $\times$ hét napja) hőtérkép}

A következő ábra a napokat ISO hét és a hét napja szerint
egymásra igazítva ábrázolja, amely lehetővé teszi
a heti ciklikusság és a szezonalitás pontosabb vizsgálatát.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/heatmap_year_weekday_aligned.png}
    \caption{Év $\times$ ISO hét $\times$ hét napja hőtérkép}
\end{figure}

Ebben a nézetben a publikálási mintázat letisztultabban értelmezhető.
A hét napjai szerint is kimutatható periodicitás jelenik meg,
miközben az éves szezonális különbségek következetesebben rajzolódnak ki.

A modern időszakban a megjelenések számának növekedése nem
kampányszerű kiugrások formájában történik, hanem folyamatos,
ami strukturális piaci bővülésre és stabil publikációs
...
A havi bontás jól szemlélteti a hosszabb távú szezonalitást és az
évről évre fokozódó volumen növekedést. A modern időszakban
...
A heti bontás kisimítja a napi szintű ingadozásokat, miközben az
éven belül jelentkező periodikus mintázatok továbbra is jól
...
\textbf{megközelítőleg 35\,789 új játékmegjelenés} becsülhető.
...
tanított log-lineáris trend segítségével előrejeleztük a 2024-es évet.
A becslés \textbf{23\,717} megjelenést adott, míg a tényleges érték
\textbf{21\,454} volt, ami hozzávetőleg \textbf{10\%-os eltérést} jelent.
