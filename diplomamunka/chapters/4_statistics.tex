...
A merged master táblában minden rekordhoz tartozik egy \textit{sources} mező, amely jelzi, hogy az adott sor mely eredeti adatforrás(ok)ból származik (A \cite{a}, B \cite{b} és C \cite{c}). Ez lehet egyetlen forrás (például \textit{A}), vagy több forrás kombinációja (például \textit{B,C} vagy \textit{A,B,C}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/heatmap_year_weekday_aligned.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/expanding_backtest_error_log_modern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/expanding_backtest_pred_vs_actual_log_modern.png}
