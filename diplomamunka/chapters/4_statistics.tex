...
A \textit{merged master} táblában minden rekordhoz tartozik egy \textit{sources} mező, amely jelzi, hogy az adott sor mely eredeti adatforrás(ok)ból származik (A \cite{a}, B \cite{b} és C \cite{c}). Ez lehet egyetlen forrás (például A), vagy több forrás kombinációja (például B, C vagy A, B, C).
