...
Az A adathalmaz részletes attribútumleírását és az egyes mezők jelentését tartalmazó adatleíró (data dictionary) a dolgozat mellékletei között érhető el.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/A_schema.pdf}
...
A B adathalmaz normalizált sémájához tartozó adatleíró (data dictionary), amely az attribútumok jelentését és típusát részletezi, a dolgozat mellékleteiben található.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/B_schema.pdf}
...
A C adathalmaz normalizált sémájához tartozó adatleíró (data dictionary), amely az egyes attribútumok jelentését és típusát részletezi, a dolgozat mellékleteiben található.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/C_schema.pdf}
...
A D adathalmaz normalizált relációs sémájának SQL-alapú megvalósítása a dolgozat mellékleteiben található. Az ott bemutatott SQL definíciók a végső adatmodellt írják le, és egyértelműen jelölik, hogy az egyes táblák és attribútumok mely forrásadathalmazokból (A, B vagy C) származnak.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/merge_folyamat.pdf}
...
\subsection{Az egységesített adathalmaz felbontása}
...
\subsubsection{A split folyamat lépései}
...
\subsubsection{A létrehozott táblák}
...
\subsubsection{A split folyamat működési elvei}
