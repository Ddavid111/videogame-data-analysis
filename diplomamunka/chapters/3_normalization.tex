...
egységesített adathalmaz előállítását követően, elsősorban a projekt
\texttt{split} könyvtárában történt. A \texttt{split/main.ipynb}
munkafüzet vezérli az egységesített \textit{merged\_master.csv} állomány
...
Harmadik lépésként az A forrás feldolgozása valósul meg, amely során a több CSV-fájlból álló Steam-metaadatok belső összevonása történik meg. Az eredmény az \textit{A\_merged.csv} állomány, amely az A adathalmaz egységesített változatát tartalmazza.
...
folyamat belépési pontja a \texttt{merge/main.ipynb} munkafüzet, amely a
teljes merge-folyamatot vezérli, és a háttérben a szükséges Python
modulokat hívja meg. A globális paraméterezést a \texttt{merge/config.py}
...
összefésülés eredményei és köztes kimenetei a \texttt{merge/generated}
könyvtárba kerülnek mentésre, beleértve a részforrásokból előállított
\textit{A\_merged.csv}, \textit{B\_full.csv}, \textit{C\_full.csv}
állományokat, valamint a végső \textit{merged\_master.csv} táblát is. A
folyamat során készült naplófájlok, jelentések és vizualizációk szintén
...
A feldolgozás belépési pontja a \texttt{split/main.ipynb} munkafüzet,
amely az egységesített \textit{merged\_master.csv} állományból kiindulva
